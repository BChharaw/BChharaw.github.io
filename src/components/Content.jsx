...
const Content = () => {
  return (
    <div
      name="main"
      className="bg-[#011627] bg-fixed bg-center bg-no-repeat pt-[80px] w-full h-screen"

    >
      <div className="pl-[20px] max-w-[1080] mx-auto px-8 flex flex-col justify-center h-full">
        <p className="text-xl sm:text-3xl text-[#2ec4b6]">Hi 👋 my name is</p>
        <h1 className="text-3xl sm:text-7xl font-bold text-[#fdfffc]">
          Brendan Chharawala
        </h1>
        <h2 className="text-xl sm:text-3xl font-bold text-[#e71d36]">
            ...
            <Typewriter
              options={{
                strings: [
                  ...
                  "Looking to expand my skills as a full stack developer 🤹‍♂️",
        ...
        <div className="py-4">
        <Link to="/projects">
          <button className="text-[#fdfffc] hover:bg-[#e71d36] border-[1px] px-4 py-1 flex items-center rounded-full ">
            My projects 
            <HiArrowNarrowRight />
          </button></Link>
        </div>
