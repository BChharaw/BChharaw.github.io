...
const ProjectsGoal = () => {
  ...
  >
    <div className="flex flex-col justify-center items-center w-full">
      ...
      <a href="https://mygoalfortoday.brenc.repl.co/" target="_blank"><button className="text-[#fdfffc] hover:bg-[#e71d36] border-[1px] px-4 py-1 flex items-center rounded-full ">
            Give it a demo! 
            <HiArrowNarrowRight />
          </button></a></div>
