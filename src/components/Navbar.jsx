  ...
  return (
    <div className="fixed w-full h-[50px] flex justify-between items-center px-4 bg-[#011627] text-gray-300">
      ...
      <ul className="md:flex hidden text-[#fdfffc]">
        <li className="hover:text-[#2ec4b6]">
        <Link to="/" >Home</Link>
        </li>
        <li className="hover:text-[#e71d36]"><Link to="/about" >About</Link></li>
        <li className="hover:text-[#2ec4b6]"><Link to="/projects" >Projects</Link></li>
        <li className="hover:text-[#e71d36]"><a href="https://drive.google.com/file/d/1y9x5pBRT5pfqdonOAjonpPgLQDFKW5cs/view?usp=sharing" target="_blank">Resume</a></li>
        <li>
          <a
            className="hover:text-[#2ec4b6] flex justify-between items-center w-full"
        ...
        <li>
          <a
            className="hover:text-[#e71d36] flex justify-between items-center w-full"
      ...
      >
        <div></div>
        <li className="hover:text-[#2ec4b6] text-4xl p-[15px]">
          <Link to="/" onClick={handleClick} >Home</Link>
        </li>
        <li className="hover:text-[#e71d36] text-4xl p-[15px]">
