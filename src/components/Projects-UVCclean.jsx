...
import uvcc from '../assets/in-tank.webp';
import withwater from '../assets/flowing-water.webp';
import uvlight from '../assets/uv-light-on.webp';
    ...
    <div className="bg-neutral-900 text-white bg-cover bg-fixed bg-center pt-32 pb-20">
      <div className="container mx-auto px-6 sm:px-8 flex flex-col justify-center h-full">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <img className="max-w-full mx-auto rounded-2xl" src={uvcc} alt="image of the UVCC system in a tank" />
